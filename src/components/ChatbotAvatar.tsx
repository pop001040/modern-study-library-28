...
export const ChatbotAvatar = () => {
  ...
  const answers = {
    ...
    "ما هو رأس المال الذي أحتاجه لبدء المشروع؟": "رأس المال الذي تحتاجه يعتمد على حجم المشروع وطبيعته. يتضمن: التكاليف الأولية (مثل المعدات والآلات)، التكاليف التشغيلية الشهرية (مثل الرواتب والإيجارات)، والتكاليف غير المتوقعة (مثل المخاطر أو التغييرات الطارئة).",
